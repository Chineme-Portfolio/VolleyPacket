...
const tiers = [
  {
    ...
    features: ["3 active jobs", "Up to 5,000 recipients per job", "10 AI chat messages/month", "Free-tier templates", "Community support"],
    cta: "Get Started",
    highlighted: false,
  },
  {
    ...
    features: ["Unlimited jobs", "Up to 10,000 recipients per job", "100 AI messages/month", "All templates", "Publish templates", "Email support"],
    cta: "Upgrade",
    highlighted: true,
  },
  {
    ...
    features: ["Unlimited jobs", "Unlimited recipients", "Unlimited AI chat", "All templates", "Priority support", "Early access to new features"],
    cta: "Upgrade",
    highlighted: false,
  },
];
